...
def scenario1_realtime_turntaking(cur, conn, cfg, params, iterations, rows, private_key):
    depths = cfg.depths
...
def scenario2_chain_churn(cur, conn, cfg, params, iterations, rows, private_key):
    depths = cfg.depths
    scale_up_nodes = cfg.scale_up_nodes
...
def scenario5_partition_reconciliation(cur, conn, cfg, params, scale_up_nodes, depths, iterations, rows, private_key):
...
if __name__ == '__main__':
    ...
    if args.scenario == '1':
        ...
        scenario1_realtime_turntaking(cur, conn, cfg, params, iterations, rows, private_key)
    elif args.scenario == '2':
        print("=== Running Scenario C-2: Chain-Churn ===")
        scenario2_chain_churn(cur, conn, cfg, params, iterations, rows, private_key)
    elif args.scenario == '3':
        print("=== Running Scenario C-3: ABAC ===")
        ...
        print("=== Running Scenario C-5: Partition & Reconciliation ===")
        scenario5_partition_reconciliation(cur, conn, cfg, params, scale_up_nodes, depths, iterations, rows, private_key)
    else:
